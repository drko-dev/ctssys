<template>
	<label>
	  <input type="checkbox" v-model="value" :autocomplete="schema.autocomplete" :disabled="disabled" :name="schema.inputName" :id="getFieldID(schema)"/><span :data-on="schema.textOn || 'On'" :data-off="schema.textOff || 'Off'" :for="getFieldID(schema)" class="label"></span><span class="handle"></span>
	</label>
</template>
