<template>
<div class="wrapper">
  <input type="text" v-show="schema.hideInput !== true" v-model="wrappedValue" :autocomplete="schema.autocomplete" :disabled="disabled" :placeholder="schema.placeholder" :readonly="schema.readonly" class="form-control link"/>
  <input type="file" v-if="schema.browse !== false" :disabled="disabled" @change="fileChanged" :name="schema.inputName" class="form-control file"/>
  <div :style="previewStyle" class="preview">
    <div title="Remove image" @click="remove" class="remove"></div>
  </div>
</div>
</template>
