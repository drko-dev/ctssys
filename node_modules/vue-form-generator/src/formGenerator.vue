<template>
<div v-if="schema != null" class="panel">
  <fieldset v-if="schema.fields" :is="tag">
    <template v-for="field in fields">
      <div v-if="fieldVisible(field)" :class="getFieldRowClasses(field)" class="form-group">
        <label v-if="fieldTypeHasLabel(field)" :for="getFieldID(field)" :class="field.labelClasses">{{ field.label }}<span v-if="field.help" class="help"><i class="icon"></i>
        ...
        <div v-if="fieldErrors(field).length &gt; 0" class="errors help-block"><span v-for="(error, index) in fieldErrors(field)" v-html="error" track-by="index"></span></div>
      </div>
    </template>
  </fieldset>
